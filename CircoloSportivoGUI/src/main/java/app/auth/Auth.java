...
public class Auth
{
  ...
  // Effettua il login dell'utente e ritorna la stringa ruolo oppure ritorna
  // stringa vuota se il login fallisce
  ...
  // Effettua la registrazione di un nuovo utente sul db, ritorna true se
  // l'account è stato registrato
  // correttamente altrimenti ritorna false
  public static boolean Register(String nome, String cognome, String email,
      String password, String passwordRpt, String ruolo)
  {
        ...
        Statement stmt = conn.createStatement();)
    {
      ...
      String insertString = "INSERT INTO utenti (nome, cognome, email, password, ruolo) VALUES ("
          + values + ")";
