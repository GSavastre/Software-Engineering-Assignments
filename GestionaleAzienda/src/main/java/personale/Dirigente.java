...
public class Dirigente extends Impiegato{
	...
	public Dirigente(String nome, String cognome, String codiceFiscale, /*Sede*/String sedeLavorativa, LocalDate inizioAttivita, LocalDate fineAttivita) {
		super(nome, cognome, codiceFiscale, sedeLavorativa, inizioAttivita, fineAttivita);
	}
	
	public Dirigente(String nome, String cognome, /*Sede*/String sedeLavorativa, LocalDate inizioAttivita) {
